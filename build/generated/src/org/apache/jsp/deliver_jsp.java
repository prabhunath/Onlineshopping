  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/onlineshopping","root","password");
      ...
      out.write("        ");
           ...
           int x=st.executeUpdate("update purchase set deliver='"+s+"' where name='"+name+"'");
            
            
            out.println(name);
            
                out.println("<form action=\"admin_itemPurchaseOrder.jsp\" method=\"post\"> <input type=\"submit\" value=\" GO Back \" class=\"btn\" ></input></form>");   
