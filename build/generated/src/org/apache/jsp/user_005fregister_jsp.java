...
public final class user_005fregister_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    </head>\n");
      out.write("    <body>\n");
      out.write("    <center> <h3 style=\"margin-top:150px;\">User Registration Form</h3></center>\n");
      out.write("    <center> \n");
      out.write("        <form method=\"post\" action=\"user_register.jsp\"    >\n");
      out.write("            <table style=\"border:0px solid white;border-radius:12px;background-color: grey;margin-top: 30px; \">\n");
      out.write("                <tr><td>\n");
      out.write("            \n");
      out.write("                        Name  </td><td> <input type=\"text\" name=\"t1\" class=\"btn\"  ></td></tr>\n");
      out.write("            <tr><td>Email</td><td><input type=\"text\" name=\"t2\" class=\"btn\" id='txtEmail'></td></tr>\n");
      ...
      out.write("          \n");
      out.write("           <tr><td></td><td> <input type=\"submit\" value=\"Register\" class=\"btn\"       onclick=\"Javascript:checkEmail();\"></td></tr>\n");
      out.write("            </table>\n");
      out.write("        </form>\n");
      out.write("        \n");
      out.write("    </center>\n");
      ...
      out.write("        ");
        ...
        ResultSet rs=st.executeQuery("select *from usertbl");
            ...
            //out.println("<h2 color=\"red\"> <b> Name &nbsp Email &nbsp Password &nbsp Mobile  &nbsp Address<br></b> </h2>");
        //while(rs.next())
                       //{
            
            //out.println("<h1>"+ rs.getString(1)+" </h1>&nbsp "+rs.getString(2)+" &nbsp "+rs.getString(3)+rs.getString(4) +"&nbsp"+rs.getString(5) +"<br>");
        //
