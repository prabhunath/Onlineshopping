...
public final class user_005fshipment_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    </head>\n");
      out.write("    <body>\n");
      out.write("     <form action=\"user_shipment.jsp\" method=\"post\">\n");
      out.write("            <table>      \n");
      out.write("                <tr><td>Enter Your Email </td><td><input type=\"text\" name=\"t1\"></td></tr>\n");
      out.write("                <tr><td>  </td><td> <input type=\"submit\" value=\"Get Status\"></td></tr>\n");
      out.write("            </table>\n");
      out.write("     </form>\n");
      out.write("   \n");
      out.write("        ");
    ...
    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/onlineshopping","root","password");
      ...
      out.write("        ");
            ...
            PreparedStatement pst=con.prepareStatement("select name ,item,deliver  from purchase where email='"+email+"'");
            ...
            {
                out.println((count)+" Your Item ('"+rs.getString(2)+"') is Delivered   You make sure payment is ready(By CASH)!!  Shipment may take 3 to 4 days !!  Thank you for purchasing with us!!<br>");
            }
            else if(status.equals("not delivered"))
            {
                out.println((count)+"Your Item ('"+rs.getString(2)+"') is not Yet Packed And not Delivered , It is under Process Thank you!!!");
            }
      ...
      out.write("        \n");
      out.write("           \n");
      out.write("            <form action=\"user_profile.jsp\">\n");
      out.write("                \n");
      out.write("                <table>\n");
      out.write("                    <tr>\n");
      out.write("                        <td>\n");
